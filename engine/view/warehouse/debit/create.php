<div id="warehouse">
	...
	<h1>Документ оприходование товара</h1>
	<p class="note">Поля со <span class="required">*</span> обязательны к заполнению.</p>
	<form id="form" action="/warehouse/debitcreate/" method="POST">
		<div class="row">
		...
		<div class="row">
			...
			<table border=1>
				...
				<tr id="end-row1"><td>1</td><td><input id="pers_id1" class="input-id" type="" name ="form_table[1][product_id]" readonly="readonly"></input><input class="autocomplete" onclick="auto()" id="autocomplete1" type="text" ></input></td><td><input id="quantity1" type="text" name="form_table[1][quantity]"></input></td><td><input id="price1" type="text" name="form_table[1][price]"></td><td>Х</td></tr>
			</table>
			<div id="notify"></div>
		</div>
		<div class="row">

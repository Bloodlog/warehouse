<div id="warehouse">
	...
	<h1>Редактирование документа отгрузки товара</h1>
	<p class="note">Поля со <span class="required">*</span> обязательны к заполнению.</p>
	<form id="form" action="/warehouse/shipupdate/?id=<?php echo $data['id'];?>" method="POST">
		<div class="row">
			<label>Наименование документа<span class="required">*</span></label>
			<input  id="name" name="form[name]" type="text" value ="<?php echo $data['ship']['name']; ?>"></input>
		</div>
		<div class="row">
		...
		<div class="row">
			<label>Автор</label>
			<input id="author" name="form[author]" type="text" value ="<?php echo $data['ship']['author']; ?>"></input>
		</div>
